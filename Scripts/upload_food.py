...
[
  {
    "foodId": "",
    "name": "Kwality Wall's Choco Bar Mini",
    "brand": "Kwality Wall's",
    "category": "Frozen Dessert",
    "subCategory": "Chocolate Coated Frozen Dessert",
    "unitType": "1 piece",
    "servingSize": 24,
    "source": "Official Nutrition Label + USDA FoodData Central (ingredient-based estimates)",
    "notes": "Values are for one 24 g Choco Bar Mini. Macronutrients are from the official nutrition label. Micronutrients are estimated from ingredients (milk solids, cocoa solids, sugar, vegetable oil, soy protein and compound chocolate coating).",
    ...
    "saturatedFat": "3.50 g",
    "monounsaturatedFat": "0.13 g",
    "polyunsaturatedFat": "0.10 g",
    "omega3": "0.00 g",
    "omega6": "0.09 g",
    "transFat": "0.00 g",
