...
function HabitLogging() {
    ...
    return (
        <div className="p-0 md:p-4 w-full max-w-full overflow-x-hidden">
            ...
            <div className="block md:hidden space-y-3 pb-24 w-full max-w-full overflow-x-hidden">
                {/* Sticky Module Navigation Tabs */}
                <div className="sticky top-0 z-30 bg-base-100/95 backdrop-blur-md px-2 py-1.5 border-b border-base-300/80 mb-1 w-full max-w-full">
                ...
                {mobileTab === "logs" && (
                    <div className="space-y-3 px-2 w-full">
                        ...
                        <div className="bg-base-100 border border-base-content/10 rounded-2xl p-4 shadow-xs space-y-2.5">
                            ...
                            <div className="max-h-60 overflow-y-auto overflow-x-auto no-scrollbar w-full">
                                {physicalLogs && physicalLogs.length > 0 ? (
                                    <table className="table table-xs w-full">
                                        <thead>
