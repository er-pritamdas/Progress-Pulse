...
function ForgotPassOtp() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("/api/v1/users/forgot-password-verification/verify-otp", {
                ...formData,
                otp: enteredOTP,
            });
            // Success Alert Popup
    ...
    const handleResendOtp = async () => {
        try {
            setLoading(true)
            await axios.post("/api/v1/users/forgot-password-verification/resend-otp", formData);
            // Success Alert Popup
