    ...
    return (
        <div className="relative">
            ...
            {activeInfo && (
                ...
                >
                    <div
                        className="bg-base-200 rounded-3xl p-6 max-w-md w-full h-[220px] relative border border-base-300 shadow-2xl flex flex-col justify-between overflow-hidden animate-in fade-in zoom-in-95 duration-200"
            ...
            <div className="block md:hidden space-y-2.5">
                {/* Row 1: Total Read & Offset side by side */}
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="stat shadow rounded-xl p-3 bg-base-100 border border-base-300/60 relative">
                        ...
                        <div className="stat-title pr-4 text-xs font-semibold">Total Read</div>
                        <div className="stat-value text-amber-500 text-xl font-bold">
                            {readSum.toFixed(1)}h
                        </div>
                        <div className="stat-desc text-[10px]">
                            Goal: {readMinGoal.toFixed(1)} - {readGoal.toFixed(1)}h
                        </div>
                    </div>
                    ...
                    <div className={`stat shadow rounded-xl p-3 bg-base-100 relative ${offset >= 0 ? 'border border-emerald-500/70' : 'border border-rose-500/70'}`}>
                        ...
                        <div className="stat-title pr-4 text-xs font-semibold truncate">Offset from {totalDays * readMin}h</div>
