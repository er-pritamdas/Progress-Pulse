...
const LongestStreakCard = React.memo(({ habitData = [], fromDate, toDate }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <Flame className="text-orange-500 mb-1 md:mb-2 w-6 h-6 md:w-8 md:h-8" />
      <h2 className="text-xs sm:text-sm md:text-xl font-semibold text-gray-800 dark:text-gray-200 text-center">Longest Streak</h2>
      <p className="text-xl sm:text-2xl md:text-3xl font-extrabold text-orange-500 mt-1 md:mt-2 mb-1.5 md:mb-6">
