...
export const NUTRIENT_CATEGORIES_CONFIG = {
  ...
  Vitamins: [
    ...
    { id: "vitaminB7", label: "Vitamin B7 (Biotin)", unit: "mcg", color: "text-purple-400", colorHex: "#c084fc", icon: Zap, isMacro: false },
    { id: "vitaminB9", label: "Vitamin B9 (Folate)", unit: "mcg", color: "text-fuchsia-400", colorHex: "#e879f9", icon: Zap, isMacro: false },
  ...
  "Fatty Acids": [
    ...
    { id: "monounsaturatedFat", label: "Monounsaturated Fat", unit: "g", color: "text-green-300", colorHex: "#86efac", icon: HeartPulse, isMacro: false },
    { id: "polyunsaturatedFat", label: "Polyunsaturated Fat", unit: "g", color: "text-emerald-300", colorHex: "#6ee7b7", icon: HeartPulse, isMacro: false },
